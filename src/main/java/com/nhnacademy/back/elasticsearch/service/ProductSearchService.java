...
public interface ProductSearchService {
	...
	Page<ResponseProductReadDTO> getProductsBySearch(Pageable pageable, String search, String sort);

	// 카테고리 리스트 조회 & 조회 후 정렬 시
	Page<ResponseProductReadDTO> getProductsByCategoryId(Pageable pageable, Long categoryId, String sort);
