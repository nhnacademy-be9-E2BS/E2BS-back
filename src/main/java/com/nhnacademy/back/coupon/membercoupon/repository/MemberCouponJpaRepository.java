...
""")
	List<ResponseOrderCouponDTO> findProductCoupons(@Param("customerId") Long customerId, @Param("productIds") List<Long> productIds);
...
""")
	List<ResponseOrderCouponDTO> findCategoryCoupons(@Param("customerId") Long customerId, @Param("productIds") List<Long> productIds);
