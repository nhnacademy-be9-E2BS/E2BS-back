...
public class MemberCouponMypageController {
	...
	public ResponseEntity<ResponseMemberCouponDTO> getMemberPoints(
		@PathVariable("memberId") String memberId) {
		ResponseMemberCouponDTO responseMemberCouponDTO = memberCouponService.getMemberCouponCnt(memberId);
